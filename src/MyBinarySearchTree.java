...
public class MyBinarySearchTree {
	//init vars
	private Node _root;
	private MyLinkedListClass _inOrder, _preOrder, _postOrder;

	public MyBinarySearchTree(){
		//default constructor
		_root = null;
		_inOrder = new MyLinkedListClass();
		_preOrder = new MyLinkedListClass();
		_postOrder = new MyLinkedListClass();
	}
	...
	public MyLinkedListClass getInOrder(){
		return _inOrder;
	}
	...
	public MyLinkedListClass getPreOrder(){
		return _preOrder;
	}
	...
	public MyLinkedListClass getPostOrder(){
		return _postOrder;
	}
	////////////////////////
